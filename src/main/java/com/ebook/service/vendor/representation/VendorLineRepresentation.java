...
public class VendorLineRepresentation extends Representation {
	...
	public VendorLineRepresentation(VendorLine vl, Integer vendorId) {
		...
		BookStoreUri getProduct = new BookStoreUri("/product", String.format("productservice/product/%d", productId),"application/json");
		BookStoreUri delVendLine = new BookStoreUri("/delete", String.format("vendorservice/vendor?vendorId=%d&productId=%d",vendorId, productId)); 
